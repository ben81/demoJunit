...
#
CONSOLE_LAUNCHER_JAR=junit-platform-console-standalone-1.1.0.jar
echo CONSOLE_LAUNCHER_JAR=${CONSOLE_LAUNCHER_JAR}
#
LIB_ROOT=./target/lib
echo LIB_ROOT=${LIB_ROOT}
#
DEPENDENT_JAR_CLASSPATH=${LIB_ROOT}/junit-platform-runner-1.1.0.jar:${LIB_ROOT}/commons-lang3-3.5.jar
...
${EXCLUDE_TAGS}  --reports-dir target/test-result